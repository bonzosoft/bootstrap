...
Write-Host "Composefile: $Script:INCLUDEDIR"
Write-Host "Composefile: $Script:COMPOSEFILE"
$Data = Get-DockerCompose -Path $Script:COMPOSEFILE
$Data
[Collections.Generic.List[string]]$volumes = Get-DockerVolumes -Data $Data
