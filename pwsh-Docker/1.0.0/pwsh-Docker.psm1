...
$Script:Context | Add-Member -MemberType NoteProperty -Name SOCKPROXY_PUID -Value $Script:Context.APP_PUID
$Script:Context | Add-Member -MemberType NoteProperty -Name SOCKPROXY_PGID -Value $Script:Context.APP_PGID
